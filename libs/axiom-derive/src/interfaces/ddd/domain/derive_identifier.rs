...
pub fn derive_identifier(tokens: proc_macro::TokenStream) -> proc_macro::TokenStream {
...
fn derive_for_struct(ast: &syn::DeriveInput, data: &syn::DataStruct) -> proc_macro2::TokenStream {
    ...
    let struct_where_clause_with_identifier_bounds = generate_where_clause_with_identifier_bounds_from_derive_input(ast);
    ...
    let struct_partial_eq_impl = derive_partial_eq_for_struct(ast, data);
...
fn derive_for_enum(ast: &syn::DeriveInput, data: &syn::DataEnum) -> proc_macro2::TokenStream {
    ...
    let enum_where_clause_with_identifier_bounds = generate_where_clause_with_identifier_bounds_from_derive_input(ast);
    let enum_where_clause_with_value_object_bounds = generate_where_clause_with_value_object_bounds_from_derive_input(ast);

    let enum_debug_impl = derive_debug_for_enum(ast, data);
    let enum_clone_impl = derive_clone_for_enum(ast, data);
    let enum_partial_eqimpl = derive_partial_eq_for_enum(ast, data);
...
fn generate_where_clause_with_identifier_bounds_from_derive_input(ast: &syn::DeriveInput) -> proc_macro2::TokenStream {
