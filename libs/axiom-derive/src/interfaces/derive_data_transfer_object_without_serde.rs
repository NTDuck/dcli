...
pub fn derive_data_transfer_object_without_serde(tokens: proc_macro::TokenStream) -> proc_macro::TokenStream {
...
fn generate_where_clause_with_data_transfer_object_bounds_from_derive_input(
    ast: &syn::DeriveInput,
